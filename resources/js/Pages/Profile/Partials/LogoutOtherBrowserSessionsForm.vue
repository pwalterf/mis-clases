...
<template>
    <JetActionSection>
        ...
        <template #description>
            Administra y cierra sesión de tus sesiones abiertas en otros navegadores y dispositivos.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Si necesitas, puedes cerrar tu sesión abierta de todos tus demas navegadores en cualquiera de tus dispositivos. Algunas de tus sesiones recientes estan listadas debajo; sin embargo, esta lista puede no ser exacta. Si sientes que tu cuenta ha sido vulnerada, debes también modificar tu contraseña.
            </div>
            ...
            <JetDialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Por favor ingresa tu contraseña para confirmar que deseas cerrar la sesión abierta de tus demás dispositivos.
